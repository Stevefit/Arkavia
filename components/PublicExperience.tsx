...
export default function PublicExperience({ slug }: { slug: string }) {
  ...
  return <main className="public-shell">
    ...
    {state === "ready" && dj && settings && <>
      ...
      <footer className="site-footer"><Wordmark silver /><div><span>THANK YOU FOR BEING PART OF THE FREQUENCY.</span><small>© ARKAVIA · MADE WITH MUSIC & GRATITUDE</small></div><a href="#top" aria-label="Kembali ke atas"><ArrowUpRight size={20} /></a></footer>
      </div>
