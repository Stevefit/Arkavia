...
export default function AdminDashboard() {
  ...
  async function uploadMusic(file?: File) {
    ...
    try {
      ...
      const result = await requestJson<{ url: string }>("/api/music/upload", { method: "POST", body: form });
      setMusicUrl(result.url); notify("File diunggah. Dengarkan preview, lalu simpan.");
    } catch (error) { fail(error); }
